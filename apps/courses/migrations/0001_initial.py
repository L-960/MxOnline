# Generated by Django 2.2 on 2020-04-28 20:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('cj', '初级'), ('zj', '中级'), ('gj', '高级')], max_length=50, verbose_name='课程难度')),
                ...
                ('image', models.ImageField(upload_to='courses/img/%Y/%m', verbose_name='课程封面图')),
            ],
            options={
                'verbose_name': '课程信息',
